...
console.log("!!! MAP V2 LOADED SUCCESSFULLY !!!");
...
require([
    ...
    const popupTemplate = {
        ...
        content: `
            ...
            <div style="display:flex; gap:10px; margin-top:10px;">
                <a href='details.html?id={facilityId}' target='_blank' class='btn' style='flex:1; text-align:center; background:#3498db; color:white; padding:8px; text-decoration:none; border-radius:4px; font-size:0.9rem;'>Vezi Detalii</a>
                <a href='add_review.html?id={facilityId}' target='_blank' class='btn' style='flex:1; text-align:center; background:#2ecc71; color:white; padding:8px; text-decoration:none; border-radius:4px; font-size:0.9rem;'>SCRIE RECENZIE</a>
            </div>
        `
    };
    ...
    async function loadFacilitiesPoints() {
        ...
        try {
            ...
            console.log("Facilities loaded:", querySnapshot.size);
            ...
            querySnapshot.forEach((doc) => {
                ...
                if (data.latitude && data.longitude) {
                    ...
                    listItem.dataset.type = data.type; // Add data-type for filtering
                    listItem.innerHTML = `
                        <h4>${data.name}</h4>
